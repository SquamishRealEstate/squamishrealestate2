        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-primary-foreground/80">
              World-class rock climbing, mountain biking, and hiking right at
              your doorstep
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-primary-foreground/80">
              Thriving local economy with strong real estate appreciation and
              development
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-primary-foreground/80">
              Close-knit community with excellent schools, dining, and cultural
              events
            </p>
          </div>
        </div>
