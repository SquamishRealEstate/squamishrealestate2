      ...
      <div className="max-w-4xl mx-auto bg-card rounded-2xl border border-border shadow-sm overflow-hidden">
        ...
        <div className="p-8 md:p-16">
          ...
          <header className="mb-12">
            ...
            <div className="flex items-center gap-3">
              <i className="text-sm font-accent text-muted-foreground uppercase tracking-widest not-italic">
                Organization: <span className="text-accent font-bold">BCREA</span>
              </i>
            </div>
          </header>
          ...
          <div className="space-y-8 text-[15px] leading-relaxed text-slate-700 dark:text-slate-300">
            ...
            <p>
              To help you sell, buy or lease real estate, <b>REALTORS®</b>, brokerages and real estate boards need to collect, use and disclose some of your personal information. This form provides you with information about, and obtains your consent to, such information handling practices.
            </p>
            ...
            <div className="frosted-glass dark:frosted-glass-dark p-6 rounded-xl border border-primary/10 shadow-inner space-y-4">
              <p>
                <span className="font-bold text-primary">Personal Information</span> may include information about your property (such as listing and selling price, lease rate, listing term, etc.).
              </p>
              <p>
                A <span className="font-bold text-primary">REALTOR®</span> is a member of a real estate board, the British Columbia Real Estate Association (BCREA) and of The Canadian Real Estate Association (CREA). REALTORS® in BC are licensed under the Real Estate Services Act.
              </p>
              <p>
                <span className="font-bold text-primary">Brokerage</span> refers to the real estate company where your REALTOR® is licensed.
              </p>
              <p>
                The <span className="font-bold text-primary">boards</span> are British Columbia real estate boards that are members of BCREA. REALTORS® provide MLS® services, which are professional to effect the purchase and sale of real estate as part of a co-operative selling system, otherwise known as an MLS® System.
              </p>
              <p>
                An <span className="font-bold text-primary">MLS® System</span> is a member-to-member cooperative selling system for the purchase, sale or lease of real estate that is owned or controlled by a board, includes an inventory of listings of participating REALTORS®, and ensures a certain level of accuracy of information, professionalism, and cooperation amongst REALTOR® members.
              </p>
            </div>
            ...
            <div className="space-y-8 pt-6">
              <section>
                <h3 className="font-display font-bold text-primary mb-2 italic underline decoration-accent/20 underline-offset-8">How is my personal information collected?</h3>
                <p>
              ...
              <section>
                <h3 className="font-display font-bold text-primary mb-2 italic underline decoration-accent/20 underline-offset-8">To whom may my personal information be disclosed?</h3>
                <p>
                ...
                <p className="mt-4 text-sm italic text-muted-foreground">
                  Not all of your information will be accessible to each of the abovementioned entities. For example, once the listing term has ended, the general public will not have access to your information, unless it is otherwise available through public registries or publications (e.g., Land Title Offices, BC Assessment, Realtor.ca)
                </p>
              </section>

              <section>
                <h3 className="font-display font-bold text-primary mb-2 italic underline decoration-accent/20 underline-offset-8">Why is my personal information collected, used and disclosed?</h3>
                <p className="mb-6">Your personal information may be collected, used and disclosed for some or all of the primary uses set out below. These primary uses are a necessary part of your relationship with the REALTOR® to whom you are giving this consent.</p>
                ...
                <ul className="space-y-4 pl-2">
                  {[
                    ...
                    <li key={idx} className="flex gap-4 items-start group">
                      <span className="font-display font-bold text-accent shrink-0 w-4">{idx + 1}.</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
              ...
              <section className="pt-10 border-t border-border">
                <h3 className="font-display font-bold text-primary mb-4 italic underline decoration-accent/20 underline-offset-8">Will my personal information be collected, used and disclosed for any other purposes?</h3>
                <p className="mb-6">
                ...
                <ol className="space-y-6 list-none pt-4">
                   {[
                    ...
                    <li key={idx} className="pl-6 border-l-2 border-accent/20">
                      <span className="font-bold text-foreground block mb-2 underline decoration-accent/10">Secondary Use {idx + 1}</span>
              ...
              <div className="font-accent text-xs uppercase tracking-widest text-muted-foreground bg-muted/30 p-6 rounded-lg border-l-2 border-accent italic mt-8">
                <p className="mb-4">
                  You may withdraw your consent to any or all of the secondary uses in the future by contacting the REALTOR® to whom you are giving this consent or that REALTOR’s Board’s privacy officer.
                </p>
                <p>
                  Contact information for all boards can be obtained from BCREA (website <a href="http://www.bcrea.bc.ca" className="text-primary hover:text-accent underline">www.bcrea.bc.ca</a> or telephone 604.683.7702).
                </p>
              </div>
            </div>
          </div>
        ...
        <footer className="bg-muted/30 py-8 px-8 border-t border-border text-center">
          <p className="font-accent text-[10px] uppercase tracking-[0.3em] text-muted-foreground font-bold">
            © {new Date().getFullYear()} British Columbia Real Estate Association
          </p>
        </footer>
      </div>
    </div>
