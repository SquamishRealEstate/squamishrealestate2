  ...
  useEffect(() => {
    if (listing) {
      ...
      const executeExecution = async () => {
        const floorplans = await fetchFloorPlans(listing, type);
  ...
  const listingInfo = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        renderComponent: () => (
          <SchoolPrograms property={listing} type={type} />
        ),
      },
    ];
            ...
            <>
                  ...
                  <div className="w-full md:w-auto flex flex-col items-end gap-3">
                    ...
                    <div className="flex items-center gap-4 py-1">
                      <PropertyActions
                        ...
                        onReport={() =>
                          scrollToRef(reportRef, "report an issue")
                        }
                      />
              ...
              <div className="bg-card border-b border-border p-6 md:p-8 pt-10 antialiased lg:flex">
                <div className="w-full lg:w-2/3 space-y-4">
                          ...
                          <span className="h-1.5 w-1.5 rounded-full mr-1.5 relative flex">
                            <span
                              className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${
                                listing?.market_status?.toLowerCase() ===
                                "active"
                                  ? "bg-primary"
                                  : "bg-accent"
                              }`}
                  ...
                  <div className="p-2 pb-8 flex items-center">
                    ...
                    <p className="text-xs md:text-sm pl-4">
                      ...
                      generated by the Chilliwack and District Real Estate
                      Board, Fraser Valley Real Estate Board or Greater
                      Vancouver REALTORS® which assume no responsibility for its
                      accuracy{" "}
                    </p>
                  </div>
                  <AuthGuard renderPrivate={false}>
                        ...
                        {reviews && reviews.length > 0 ? (
                          ...
                          <div className="py-12 text-center flex flex-col items-center justify-center">
                            ...
                            <p className="text-[10px] text-muted-foreground italic leading-relaxed max-w-[200px]">
                              Be the first to share your insights about this
                              property!
                            </p>
                          </div>
                        )}
                ...
                <div className="lg:w-1/3 lg:pl-8">
                  <AuthGuard renderPrivate={false}>
                    {(user, loginUI) => (
                      <ListingExplorerTabs listing={listing} />
                    )}
                  </AuthGuard>
                  <ThinkingOfSelling />
                  <AuthGuard renderPrivate={false}>
