...
//   // 🌟 1. Build a smart display array. If less than 3 pictures exist, pad it up to 7 with system defaults.
...
//     // Append fallback images that aren't already represented in the list
...
//   // Pick out the top 3 items to cleanly show in the main grid layout tracks
...
//   // State to track active lightbox view index
...
//         {/* Bottom Right Small Image Panel */}
//         <div
...
//           {/* 🌟 NEW FIXED BOTTOM RIGHT POSITION FOR THE BUTTON */}
//           {remainingCount > 0 && (
...
//       {/* FULL SCREEN LIGHTBOX CAROUSEL OVERLAY */}
...
//           {/* Active Centered Image Container */}
//           <div className="relative max-w-5xl max-h-[85vh] w-full h-full px-4 flex flex-col items-center justify-center select-none">
//             <img
//               className="max-w-full max-h-[80vh] object-fill rounded-md shadow-2xl animate-in zoom-in-95 duration-200"
//               src={displayPhotos[activePhotoIndex]}
//               alt={`Expanded property view ${activePhotoIndex + 1}`}
...
// 1. Add 'singlePhotoOnly' to your component props configuration
