...
export const mockListings: Listing[] = [
  ...
  },
  {
    ...
    lat: 49.6505,
    lng: -123.2050,
    description: "Exceptional waterfront property on Howe Sound with private dock and breathtaking mountain views. Expansive deck, native landscaping, and luxurious finishes.",
    features: ["Waterfront", "Private Dock", "Mountain Views", "Expansive Deck", "Luxury Finishes"]
  },
  {
    id: "3",
    ...
    lat: 49.7016,
    lng: -123.1558,
    description: "Modern condo in the heart of downtown Squamish. Walk to shops, restaurants, and outdoor recreation. Mountain views from the balcony.",
    features: ["Downtown Location", "Mountain Views", "Modern Finishes", "Walkable", "Balcony"]
  },
  {
    id: "4",
    ...
    lat: 49.7500,
    lng: -123.1833,
    description: "Spacious family home in peaceful Brackendale. Large yard, updated kitchen, and close to schools. Perfect for families seeking mountain lifestyle.",
    features: ["Family Friendly", "Large Yard", "Updated Kitchen", "Near Schools", "Quiet Neighborhood"]
  },
  {
    id: "5",
    ...
    lat: 49.6833,
    lng: -123.1667,
    description: "Contemporary townhouse with open-concept living and mountain views. Close to trails and climbing areas. Low-maintenance lifestyle.",
    features: ["Townhouse", "Open Concept", "Mountain Views", "Near Trails", "Low Maintenance"]
  },
  {
    id: "6",
    ...
    lat: 49.7167,
    lng: -123.1417,
    description: "Prestigious Garibaldi Estates home with chef's kitchen, home theater, and wine cellar. Impeccable finishes and stunning mountain vistas.",
    features: ["Luxury", "Chef's Kitchen", "Home Theater", "Wine Cellar", "Mountain Vistas"]
  },
  {
    id: "7",
    ...
    lat: 49.6917,
    lng: -123.1583,
    description: "Perfect starter home near Brennan Park. Cozy layout, fenced yard, and close to recreation facilities. Great value in desirable location.",
    features: ["Starter Home", "Fenced Yard", "Near Recreation", "Cozy Layout", "Great Value"]
  },
  {
    id: "8",
    ...
    lat: 49.6833,
    lng: -123.1500,
    description: "Charming character home with original wood details and modern updates. Large lot with mature trees and garden space.",
    features: ["Character Home", "Large Lot", "Mature Trees", "Garden Space", "Updated"]
  }
];
